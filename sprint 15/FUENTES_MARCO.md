...
|---|---|---|
| sec. 1.1.1 Software engineering | *"A software process is a sequence of activities that leads to the production of a software product. **Four fundamental activities are common to all software processes**"*: (1) software specification — *"customers and engineers define the software that is to be produced and the constraints on its operation"*; (2) software development; (3) software validation — *"the software is checked to ensure that it is what the customer requires"*; (4) software evolution. Y: *"these generic activities may be organized in different ways and described at different levels of detail, depending on the type of software being developed"* | **v3 sec. 1**: las cuatro actividades y el encuadre **agnóstico al modelo de proceso** |
| sec. 2.2.3 Software validation | *"Software validation or, more generally, verification and validation (V & V) is intended to show that a system both conforms to its specification and meets the expectations of the system customer"* | **v3 sec. 1**: la V&V se chequea contra las expectativas del cliente, no solo contra el documento |
| Introducción del cap. 4 (antes de la sec. 4.1) | *"System stakeholders include anyone who is affected by the system in some way and so anyone who has a legitimate interest in it. Stakeholders range from end-users of a system through managers to external stakeholders such as regulators, who certify the acceptability of the system."* ⚠ **no** está en la sec. 4.1 (que arranca después): es la introducción del capítulo | **v3 sec. 2 y *Definiciones***: definición amplia de stakeholder, sobre la que la tesis hace su recorte |
| Introducción del cap. 8 (antes de la sec. 8.1) | *"Validation: Are we building the right product? · Verification: Are we building the product right?"* ⚠ mismo caso que la fila de abajo: está en la introducción del capítulo, **no** en la sec. 8.1 | **v3 sec. 2**: las dos preguntas que separan las ramas del V-model |
