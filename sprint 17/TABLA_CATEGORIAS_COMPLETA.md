# Tabla de categorías completa: evidencia actual + candidatos de la recodificación

Para el procesamiento a dos: cada categoría con lo que el marco ya cita y la ficha de cada candidato (qué es, dónde salió, por qué cae, con qué cautela). El marco v3 no se modificó; los candidatos entran cuando se aprueben acá.

Los marcados con ⭐ son los que tienen más peso (empiria o venue fuerte).
