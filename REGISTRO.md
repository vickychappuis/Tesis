...
- **Pendiente:** armar la **v3** del marco con la nueva estructura; conectar las técnicas con la tabla de escenarios; agregar capa de aspectos no cubiertos; definir "stakeholder" desde Sommerville. Detalle en `sprint 15/resumen_call.md` ("Próximos pasos — Sprint 16").
